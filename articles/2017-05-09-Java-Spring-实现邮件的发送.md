---
title: "Java + Spring 实现邮件的发送"
date: 2017-05-09
category: 后端开发
tags: [spring, javamail]
---
...
下图用于演示两帐户相互发送邮件的过程:   
 ![这里写图片描述](https://img-blog.csdn.net/20170508170721460?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbm9hbWFuX3dncw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
因为本文只做如何发送邮件的介绍，发送邮件跟SMTP协议相关，所以在发送前需要保证所使用的邮件客户端开启了SMTP相关服务。本文采用的是QQ邮箱（也可以改用163邮箱)。   
 ...
 ![这里写图片描述](https://img-blog.csdn.net/20170508170832170?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbm9hbWFuX3dncw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)

按照要求发送短信后点击”我已发送”，会接收到一个像下面图片中的授权码，这个授权码要记下来，在后续代码实现中的密码用到的就是这个授权码(不是qq账号密码)：   
 ![这里写图片描述](https://img-blog.csdn.net/20170508171014546?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbm9hbWFuX3dncw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
首先引入jar包：   
 下载Javax Mail的jar包<https://java.net/projects/javamail/pages/Home>
...
public class JavaMailDemo {
    ...
    //此为SMTP客户端的授权码(每个人不一样，与上面的邮箱账号对应)
...
程序运行成功以后，即可收到一封类似下图的邮件：   
 ![这里写图片描述](https://img-blog.csdn.net/20170508171213826?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbm9hbWFuX3dncw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)
...
**4 测试**   
 运行项目后打开postman进行测试：   
 ![这里写图片描述](https://img-blog.csdn.net/20170508171412688?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbm9hbWFuX3dncw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)

从返回的JSON字符串可以看出发送已经成功。   
 并且确实收到一份邮件:   
 ![这里写图片描述](https://img-blog.csdn.net/20170508171434080?watermark/2/text/aHR0cDovL2Jsb2cuY3Nkbi5uZXQvbm9hbWFuX3dncw==/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70/gravity/SouthEast)

---

参考：<http://blog.csdn.net/xietansheng/article/details/51673073>   
 我的个人博客链接：<https://nomico271.github.io/>